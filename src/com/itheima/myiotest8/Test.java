...
public class Test {
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        //1.读取正确的用户名和密码
        BufferedReader br = new BufferedReader(new FileReader("D:\\Java project\\代码\\src\\com\\itheima\\myiotest8\\userinfo.txt"));
    ...
    * */
    public static void writeInfo(String content) throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter("D:\\Java project\\代码\\src\\com\\itheima\\myiotest8\\userinfo.txt"));
        bw.write(content);
        bw.close();
    }
}