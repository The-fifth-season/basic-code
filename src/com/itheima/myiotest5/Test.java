...
public class Test {
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        String src = "D:\\Java project\\代码\\src\\com\\itheima\\myiotest6\\names.txt";
        //2.定义变量，表示备份文件，一开始文件为空
        String backups = "D:\\Java project\\代码\\src\\com\\itheima\\myiotest5\\backups.txt";
        ...
        //获取0索引的学生信息并删除
        String stuInfo = list.remove(0);                    //该方法可以把删除的数据返回，可以通过这种方法得到删除的数据
        //打印随机到的学生信息
